...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        struct Vector3 : public XMFLOAT3
        {
           ...
           static Vector3 MyMul(const Vector3& v1, float s);
           static Vector3 MyAdd(const Vector3& v1, const Vector3& v2);
           static Vector3 MyDiv(const Vector3& v1, float s);
            ...
            static Vector3 normalize(const Vector3& v1) noexcept;
            ...
            static void Slerp(const Vector3& v1, const Vector3& v2, float t, Vector3& result) noexcept;
            static Vector3 Slerp(const Vector3& v1, const Vector3& v2, float t) noexcept;
        ...
        struct Matrix : public XMFLOAT4X4
        {
            ...
            Matrix LeftHand() const noexcept;
            void LeftHand(Matrix& result) const noexcept;
            ...
            static Matrix Slerp(const Matrix& M1, const Matrix& M2, float t) noexcept;
